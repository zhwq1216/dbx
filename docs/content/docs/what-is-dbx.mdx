---
title: What is DBX?
description: DBX is an open-source, lightweight workspace for 90+ databases and data systems, with desktop and self-hosted access, AI, CLI, and MCP.
---

DBX is an open-source, lightweight workspace for databases and data infrastructure. It brings connection management, object browsing, SQL editing, data changes, schema tools, specialized consoles, and automation into one interface across 90+ databases and data systems.
