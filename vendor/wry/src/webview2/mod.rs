...
impl InnerWebView {
  ...
  fn create_environment(
    ...
    unsafe {
      ...
      let browser_executable_folder = configured_browser_executable_folder();
      let browser_executable_folder_ptr = browser_executable_folder
        .as_ref()
...
pub fn platform_webview_version() -> Result<String> {
  ...
  let browser_executable_folder_ptr = browser_executable_folder
    ...
    .unwrap_or_else(PCWSTR::null);
  unsafe {
    GetAvailableCoreWebView2BrowserVersionString(browser_executable_folder_ptr, &mut versioninfo)
  }?;
